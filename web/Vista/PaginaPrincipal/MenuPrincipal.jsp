...
<html>
    ...
    <div class="container">
        ...
        <div class="card">
            <img src="../imagenes/Carrusel/22367f_dde37ab30e50420d80877494a38afeff~mv2.jpg">
            <h4>Empresarial</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel, excepturi unde?</p>
            <a href="../PaginaPrincipal/frmAgregarInvitado.jsp">Asistir</a>
        </div>
        
        <div class="card">
            <img src="../imagenes/Carrusel/sena5.jpg">
            <h4>Institucional</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel, excepturi unde?</p>
            <a href="../PaginaPrincipal/frmAgregarInvitado.jsp">Asistir</a>
        </div>
        ...
        <div class="card">
            <img src="../imagenes/Carrusel/SENA2.jpg">
            <h4>Tecnología</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel, excepturi unde?</p>
            <a href="../PaginaPrincipal/frmAgregarInvitado.jsp">Asistir</a>
        </div>
